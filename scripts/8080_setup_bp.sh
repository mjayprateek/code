...
#curl -u admin:admin -F file=@"/Users/pkhatri/adobe/scripts/packages/mac-config.zip" -F name="Mac Config & Externalizer"  -F force=true -F install=true http://localhost:8080/crx/packmgr/service.jsp
